...
interface OpenToggleSidebarIconProps {
  color?: string; // Опциональное свойство для изменения цвета
}

const OpenToggleSidebarIcon: React.FC<OpenToggleSidebarIconProps> = ({color = '#131314'}) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <g clipPath="url(#clip0_2022_2562)">
        <path
...
export default OpenToggleSidebarIcon;
